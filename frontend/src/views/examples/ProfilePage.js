...
export class ProfilePage extends Component {
  ...
  componentDidMount() {
    axios
      .get(`/api/profile-page/${this.props.match.params.id}`)
      .then((resp) => {
        this.setState({
          user: resp.data.user,
  ...
  followingHandler = () => {
    axios
      .put(`/api/user/${this.state.userId}/follow`)
      .then((resp) => {
        this.setState({
          user: resp.data,
      ...
      <BodyClassName className="profile-page sidebar-collapse">
        <div onClick={this.emailVerification}>
              ...
              <Container>
                ...
                <div className="content" style={{ textAlign: 'center' }}>
                  <div className="social-description">
                    <h2>
                      {this.state.user && this.state.user.followers.length}
                    </h2>
                    <p
                      onClick={() =>
                        this.setState({ isClickedFollowers: true })
                      }
                  ...
                  <div className="social-description">
                    ...
                    <p
                      onClick={() =>
                        this.setState({ isClickedFollowing: true })
                      }
                      style={{ cursor: 'pointer' }}
                    >
                      Following
                ...
                <ProfilePagePortfolio
                  handelIsClickedStories={this.handelIsClickedStories}
          ...
          {this.state.isClickedFollowers && (
            <FollowModal
              setIsClickedFollow={this.setIsClickedFollowers}
          ...
          {this.state.isClickedFollowing && (
            <FollowModal
              setIsClickedFollow={this.setIsClickedFollowing}
