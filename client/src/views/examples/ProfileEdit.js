...
class ProfileEdit extends Component {
  ...
  handlePasswordFormSubmit = (event) => {
    ...
    axios
      .put(`/api/password/${this.props.currentUser._id}`, {
        oldPassword,
        newPassword,
      })
      .then((resp) => {
  ...
  handleFormSubmit = (event) => {
    ...
    const newPassword = this.state.newPassword
    axios
      .put(`/api/user/${this.props.currentUser._id}`, {
        email,
        password,
        about,
        imageUrl,
              ...
              <Col className="px-0 my-auto" md="6">
                ...
                >
                  <CardBody>
                    ...
                    />
                    <ImageUpload
                      imageUrl={this.state.bgImageUrl}
                      handleImageChange={this.handleBgImageChange}
                      handleImageRemove={this.handleBgImageRemove}
                    />
                    {/* email */}
                    {this.state.successMessage ? (
                      <AlertMessage
                        ...
                        setAlertBool={this.setAlertBool}
                    ...
                    >
                      ...
                      ></Input>
                      <Button
                        className=" btn-morphing btn-info"
